<template>
    <div class="flex flex-1 justify-center mb-1 last:mb-0" :class="[
        ...
        <Cell v-for="(char, index) in convertedGuess" :animations="!correct" :small="small" :key="index" :value="char[0]" :status="char[1]" :hint="hints[index]" :constraint="constraints.indexOf(index) >= 0"/>
    </div>
</template>
