...
export default {
    ...
    computed: {
        ...
        hints() {
            return this.$store.getters[`game/${this.mode}/hints`]
        },
        tries() {
            return this.$store.state.game[this.mode].guesses.length > this.$store.state.game[this.mode].tries ? this.$store.state.game[this.mode].guesses.length : this.$store.state.game[this.mode].tries 
        },
        remaining() {
