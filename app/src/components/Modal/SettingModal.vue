        ...
        <div class="w-full max-w-lg dark:text-white text-sm relative">
            ...
            <div class="border-b border-solid border-gray-300 dark:border-gray-700 py-4 text-left flex justify-between">
                ...
                <div class="flex items-center">
                    <Toggle :value="darkMode" @toggle="toggleDarkMode"/>
                </div>
            </div>
            <div class="border-b border-solid border-gray-300 dark:border-gray-700 py-4 text-left flex justify-between">
                <div>
                ...
                <div class="flex items-center">
                    <Toggle :value="colorBlind" @toggle="colorBlind = !colorBlind"/>
                </div>
            </div>
            <div class="border-b border-solid border-gray-300 dark:border-gray-700 py-4 text-left flex justify-between">
                <div>
                ...
                <div class="flex items-center">
                    <Toggle :value="modeTimeChallenge" @toggle="toggleTimeChallenge"/>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        toggleTimeChallenge() {
            this.$store.dispatch('timeChallenge')
        }
    }
}
</script>
